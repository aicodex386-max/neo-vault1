...
Configure credentials by creating a `.env` file in the skill directory:
...
### 3. Summarize
After analysis, read the saved JSON files and create a markdown summary with data tables, comparisons, and insights.
...
| `searchAndAnalyze(query)` | Search + stats | Search results with full video statistics |
